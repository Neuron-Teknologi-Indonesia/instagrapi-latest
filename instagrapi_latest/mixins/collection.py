...
from instagrapi_latest.exceptions import CollectionNotFound
from instagrapi_latest.extractors import extract_collection, extract_media_v1
from instagrapi_latest.types import Collection, Media
